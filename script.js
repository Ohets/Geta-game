...
function flightSimReal(){
 ...
 const viewBar=document.createElement("div");viewBar.style.cssText="position:absolute;left:50%;top:8px;transform:translateX(-50%);z-index:25;display:flex;gap:4px;flex-wrap:wrap;justify-content:center";
