...
function flightSimReal(){
 ...
 const viewBar=document.createElement("div");viewBar.style.cssText="position:absolute;left:50%;top:4px;transform:translateX(-50%);z-index:25;display:flex;gap:2px;flex-wrap:nowrap;justify-content:center;width:58%";
