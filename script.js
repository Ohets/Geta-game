...
function flightSimReal(){
 ...
 const flightDirector=document.createElement("div");flightDirector.style.cssText="position:absolute;left:34%;top:34%;width:32%;height:20%;pointer-events:none;z-index:20";flightDirector.innerHTML='<div style="position:absolute;left:50%;top:0;width:3px;height:100%;background:#e7d33f"></div><div style="position:absolute;left:0;top:50%;width:100%;height:3px;background:#e7d33f"></div>';const cockpitHud=document.createElement("div");cockpitHud.style.cssText="position:absolute;inset:0;pointer-events:none;z-index:18;display:none;color:#d9f5ff;font-family:monospace";
